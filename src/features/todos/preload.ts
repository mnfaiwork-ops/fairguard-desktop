...
This service will only work with accounts registered with Franz - no FairGuard accounts will work here!
If you do not have a Franz account you can change the Todo service by going into FairGuard's settings and changing the "Todo server".
